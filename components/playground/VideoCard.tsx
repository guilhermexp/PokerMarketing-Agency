...
export const VideoCard: React.FC<VideoCardProps> = ({ post }) => {
  ...
  return (
    <motion.div
      className="relative w-full h-full rounded-3xl overflow-hidden bg-neutral-900/40 border border-white/5 aspect-[9/16] group shadow-2xl shadow-black/50 ring-1 ring-black/50 flex flex-col"
