...
describe("upload routes", () => {
  ...
  it("uploads multipart assets through the service layer", async () => {
    ...
    const response = await request(app)
      .post("/api/upload")
      .field("filename", "file.png")
      .field("contentType", "image/png")
      .attach("file", Buffer.from("foo"), {
        filename: "file.png",
    ...
    expect(uploadBase64AssetMock).toHaveBeenCalledWith({
      filename: "file.png",
      contentType: "image/png",
