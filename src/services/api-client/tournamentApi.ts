...
export async function addEventFlyer(eventId: string, flyerUrl: string): Promise<unknown> {
...
export async function removeEventFlyer(eventId: string, flyerUrl: string): Promise<unknown> {
  return fetchApi(`/tournaments/event-flyer?event_id=${eventId}`, {
    method: "PATCH",
