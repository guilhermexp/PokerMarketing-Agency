  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-3 gap-4">
        <a
          href="/admin/users"
          className="bg-white/[0.02] border border-border rounded-lg p-4 hover:border-amber-500/30 transition-colors group"
        >
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-md bg-white/[0.04] flex items-center justify-center text-muted-foreground group-hover:text-amber-500 transition-colors">
