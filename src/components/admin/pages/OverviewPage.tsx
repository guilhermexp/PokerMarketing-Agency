...
export function OverviewPage() {
  ...
  if (error) {
    return (
      <div className="bg-red-500/10 border border-red-500/20 rounded-xl p-4 text-red-400 text-[13px]">
        {error}
      </div>
    );
  }
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <StatsCard
          ...
          subtitle={`R$ ${(((stats?.aiCostThisMonth || 0) / 100) * 6.0).toFixed(2).replace('.', ',')}`}
          color="amber"
          icon={
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      <div className="grid grid-cols-3 gap-4">
        <a
          href="/admin/users"
          className="bg-white/[0.02] border border-border rounded-xl p-4 hover:border-amber-500/30 transition-colors group"
        >
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-lg bg-white/[0.04] flex items-center justify-center text-muted-foreground group-hover:text-amber-500 transition-colors">
            ...
            <div>
              ...
              <p className="text-[11px] text-muted-foreground">Gerenciar usuários</p>
            </div>
          </div>
        </a>
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-muted-foreground">Analytics detalhado</p>
            </div>
          </div>
        </a>
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-muted-foreground">Atividade do sistema</p>
            </div>
          </div>
        </a>
      </div>
