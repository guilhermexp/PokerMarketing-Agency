...
export const ApiKeyDialog: React.FC<ApiKeyDialogProps> = ({ onContinue }) => {
  return (
    <div className="fixed inset-0 bg-black/70 backdrop-blur-md flex items-center justify-center z-50 p-4 transition-opacity duration-300">
      <div className="bg-[#000000]/60 border border-border backdrop-blur-2xl rounded-2xl shadow-[0_8px_30px_rgba(0,0,0,0.5)] max-w-md w-full p-8 text-center flex flex-col items-center relative overflow-hidden">

        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-3/4 h-20 bg-white/5 blur-3xl pointer-events-none"></div>

        <div className="bg-white/5 p-5 rounded-full mb-6 ring-1 ring-ring shadow-[inset_0_0_20px_rgba(255,255,255,0.05)] relative z-10">
