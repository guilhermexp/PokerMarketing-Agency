...
export const ApiKeyDialog: React.FC<ApiKeyDialogProps> = ({ onContinue }) => {
  return (
    <div className="fixed inset-0 bg-black/70 backdrop-blur-md flex items-center justify-center z-50 p-4 transition-opacity duration-300">
      <div className="bg-[#000000]/60 border border-white/10 backdrop-blur-2xl rounded-2xl shadow-[0_8px_30px_rgba(0,0,0,0.5)] max-w-md w-full p-8 text-center flex flex-col items-center relative overflow-hidden">
