    ...
    onSchedulePost,
        ...
        useEffect(() => {
          ...
          return (
              <>
                  <div
                      className="bg-white/[0.02] border border-white/[0.06] rounded-2xl overflow-hidden flex flex-col h-full transition-all hover:border-white/[0.08]"
                  >
                      ...
                      <div className="flex items-center gap-2">
                          ...
                          {onSchedulePost &&
                              ...
                              (() => {
                                  ...
                                  return isScheduled ? (
                                      <span className="px-2 py-1 text-[9px] font-medium text-emerald-400 bg-emerald-500/10 border border-emerald-500/20 rounded-md">
                                          Agendado
                                      </span>
                                  ) : (
                                      <button
                                          ...
                                          className="p-2 bg-white/[0.04] hover:bg-white/[0.08] border border-white/[0.06] hover:border-white/[0.1] rounded-lg transition-all"
                                          title="Agendar publicação"
                                      >
                                          <Icon name="calendar" className="w-4 h-4 text-white/50" />
                                      </button>
                                  );
                              })()}
                          <Button
                              ...
                              icon="zap"
                              className={events.length > 0 ? "bg-white/[0.1] border-white/[0.15] hover:bg-white/[0.15]" : ""}
                          >
                              Gerar
                          </Button>
                      </div>
                  </div>
                  <div className="flex-1 p-4 relative min-h-[300px] bg-white/[0.01]">
                    <FlyerThumbStrip
