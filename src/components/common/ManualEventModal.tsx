...
export const ManualEventModal: React.FC<ManualEventModalProps> = ({
  ...
  const inputClass =
    "w-full bg-transparent border border-border rounded-md px-3 py-2 text-xs text-white outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/40 aria-invalid:border-destructive placeholder:text-muted-foreground";
