    ...
    >
      ...
      <div className="flex items-center justify-between px-4 py-3">
        <button
          ...
          className="p-2 text-muted-foreground hover:text-white/70 transition-colors disabled:opacity-40"
        >
          <Icon name="x" className="w-5 h-5" />
        </button>
        <span className="text-xs text-muted-foreground uppercase tracking-wider">Recortar</span>
      ...
      >
        ...
        {completedCrop && (
          <button
            ...
            disabled={isProcessing}
            className="mt-4 px-3 py-1.5 text-[10px] text-muted-foreground hover:text-white/80 border border-border rounded-full transition-all disabled:opacity-40 disabled:cursor-not-allowed flex items-center gap-1.5 backdrop-blur-sm"
          >
            {isProcessing ? (
              <>
        ...
        {!crop && (
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
            <div className="bg-black/60 backdrop-blur-sm px-4 py-2.5 rounded-lg border border-border">
